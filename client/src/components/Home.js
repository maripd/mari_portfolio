...
//           <button className="projectbutton show">PROJECT 1</button>
//         </div>
//         <div className="project2tab-container tab-innercontainer">
//           <button className="projectbutton hide">PROJECT 2</button>
//         </div>
//         <div className="project3tab-container tab-innercontainer">
//           <button className="projectbutton hide">PROJECT 3</button>
//         </div>
//         <div className="project4tab-container tab-innercontainer">
//           <button className="projectbutton hide">PROJECT 4</button>
//         </div>
//         <div className="project5ttab-container tab-innercontainer">
//           <button className="projectbutton hide">PROJECT 5</button>
//         </div>
//       </div>
